...
emscripten_markdown(char *str)
{
	...
	markdown = sd_markdown_new(MKDEXT_STRIKETHROUGH | MKDEXT_NO_INTRA_EMPHASIS | MKDEXT_TABLES | MKDEXT_FENCED_CODE | MKDEXT_AUTOLINK | MKDEXT_SUPERSCRIPT | MKDEXT_SUBSCRIPT | MKDEXT_LAX_SPACING, 16, &callbacks, &options);
